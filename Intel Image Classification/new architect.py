...
def prepare_dataloader(df, trn_idx, df_valid, val_idx):
...
test_root_path = "./data/seg_test/seg_test"
if __name__ == "__main__":
    ...
    train_loader, val_loader = prepare_dataloader(train, train_idx, valid, valid_idx)
